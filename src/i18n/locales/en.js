...
export default {
  ...
  vault: {
    ...
    attachmentHint: 'optional · documents or photos · max 25 MB',
    ...
    errFileTooLarge: 'File exceeds the 25 MB size limit.',
    errFileType: 'Only documents (PDF, DOCX, XLS, XLSX) and photos (JPG, PNG, WEBP, HEIC) are allowed.',
    fileDeleteFailed:
      'The entry was removed, but the stored file could not be deleted. Try again so no copy is left behind.',
    notes: 'Notes',
