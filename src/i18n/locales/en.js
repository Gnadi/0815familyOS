...
export default {
  ...
  notifications: {
    ...
    whileOpenHint: 'For now, reminders arrive while myFAOS is open or running in the background on this device. Reminders with the app fully closed are coming next.',
