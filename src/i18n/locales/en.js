...
export default {
  ...
  settings: {
    ...
    revokeInvite: 'Revoke',
    revokeInviteConfirm: 'Revoke this invite link? Anyone still holding it will no longer be able to join.',
    errInviteCreate: 'Could not create an invite link.',
    errInviteRevoke: 'Could not revoke the invite link.',
    copy: 'Copy',
