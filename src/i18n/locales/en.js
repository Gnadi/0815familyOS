...
export default {
  ...
  notifications: {
    title: 'Reminders',
    intro: 'Get a nudge for upcoming appointments, the next possible medicine dose, tasks due today and vaccinations.',
    enable: 'Turn on reminders on this device',
    disable: 'Turn off on this device',
    test: 'Send a test',
    testTitle: 'Reminders are on',
    testBody: 'This is how myFAOS will remind you.',
    testFailed: 'The test notification could not be shown.',
    permissionDenied: 'Notifications were not allowed. You can allow them in your browser settings.',
    blocked: 'Notifications are blocked for myFAOS in this browser. Allow them in the site settings, then come back here.',
    needsInstall: 'On iPhone and iPad, reminders only work once myFAOS is on your Home Screen: tap Share, then "Add to Home Screen", and open it from there.',
    unsupported: "This browser can't show notifications.",
    saveFailed: 'Could not save your reminder settings.',
    remindMeOf: 'Remind me of',
    events: 'Appointments',
    eventScope: {
      mine: 'Mine and unassigned',
      all: 'All',
      off: 'Off',
    },
    leadTime: 'How early',
    minutesBefore: '{count} min before',
    trackers: 'Tracker: next dose and open daily goals',
    tasks: 'My tasks due today',
    vaccinations: 'Vaccinations due',
    whileOpenHint: 'On this device, reminders arrive while myFAOS is open or running in the background.',
    pushHint: 'Reminders also arrive when myFAOS is closed; they may then come a few minutes late.',
    eventAt: 'Starts at {time}',
    eventAtWhere: 'Starts at {time} · {location}',
    eventToday: 'Today',
    taskDue: 'Due today',
    vaccinationTitle: 'Vaccination for {name}',
    vaccinationDue: '{vaccine} is due today.',
    trackerDose: 'The next dose for {name} is possible now.',
    trackerGoal: '{name}: {count} still open today.',
    summaryTitle: '{count} reminders',
  },
  settings: {
    title: 'Settings',
  ...
  events: {
    ...
    allDayLabel: 'All day',
    endDateLabel: 'Until',
    errEndBeforeStart: 'The end date cannot be before the start.',
    occurrenceNote: 'You are changing only the event on {date}. The rest of the series stays as it is.',
    confirmDeleteOccurrence: 'Delete only the event on {date}? The rest of the series stays.',
    conflictTitle_one: 'Overlaps with another event',
    conflictTitle_other: 'Overlaps with {count} events',
    conflictHint: 'You can still save it.',
  },
  calendar: {
    thisWeek: 'This Week',
    ...
    timelineHint: 'Tap a block to open it, or an empty spot to add an event.',
    showDetails: 'Details',
    hideDetails: 'Less',
    ...
    editScopeTitle: 'Repeating event',
    editScopeText: 'Change only this date or the whole series?',
