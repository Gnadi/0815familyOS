...
export default {
  ...
  vault: {
    ...
    attachment: 'Anhang',
    attachmentHint: 'optional · Dokumente oder Fotos · max. 25 MB',
    ...
    errFileTooLarge: 'Die Datei überschreitet das Limit von 25 MB.',
    errFileType: 'Nur Dokumente (PDF, DOCX, XLS, XLSX) und Fotos (JPG, PNG, WEBP, HEIC) sind erlaubt.',
    fileDeleteFailed:
      'Der Eintrag wurde entfernt, die gespeicherte Datei konnte aber nicht gelöscht werden. Versuch es erneut, damit keine Kopie zurückbleibt.',
    notes: 'Notizen',
